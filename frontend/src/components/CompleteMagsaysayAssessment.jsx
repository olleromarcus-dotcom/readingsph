  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-yellow-50 to-orange-50 relative">
      ...
      <div className="pt-20 relative z-10">
        ...
        {/* Programs Section */}
        <section id="programs" className="py-12 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-amber-900 mb-8 text-center flex items-center justify-center">
              <Building className="mr-3" /> PROGRAMS AND PROJECTS
            </h2>
            <MagsaysayPrograms />
          </div>
        </section>
...
export default CompleteMagsaysayAssessment;